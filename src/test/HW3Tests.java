...
public class HW3Tests {
	...
	public void testDelete() {
		...
		assertTrue(kl.get(0).compare(RelationalOperator.EQ, new IntField(1))
				|| kl.get(0).compare(RelationalOperator.EQ, new IntField(4)));
	...
	public void testDeleteMergeNodes() {
		...
		// 4 is max of left child, so that should be the only key, the other two should
		// be null
	...
	@Test
	/*
	 * test HigherDegrees deletion for int. Only involves merge.
	 */
	public void testHigherDegreesDelete() {
		...
		assertTrue(k.get(0).compare(RelationalOperator.EQ, new IntField(2))
				|| k.get(0).compare(RelationalOperator.EQ, new IntField(3)));
