...
public class HW2Tests {
	...
	public void testJoinR() {
		...
		assertTrue("The size of the tuples should reflect the additional columns from the join",
				tr.getDesc().getSize() == 141);
	}
	...
	public void testJoinOnStringFieldsQ() {
		...
		assertEquals("Value of column s1 should be match given string.", matchString,
				((StringField) sField).getValue());
		assertEquals("Value of column s1 should match value of column c2, that was the WHERE clause of the JOIN.",
				((StringField) sField).getValue(), ((StringField) testField).getValue());
	}
